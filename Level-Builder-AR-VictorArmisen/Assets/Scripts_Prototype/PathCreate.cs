...
public class PathCreate : MonoBehaviour
{
    ...
    int stateTower = 0;
    public OnePlane onePlane;
    public Camera maincamera;
    private List<Vector3> storagePoints = new List<Vector3>();
    ...
    void Update()
    {
        ...
        if(play)
        {
            ...
            Instantiate(hordeObject, new Vector3(manager.pointList[0].x - 2.0f, manager.pointList[0].y + 5.0f, manager.pointList[0].z + 3.0f), hordeObject.transform.rotation);
        }
    }
}
